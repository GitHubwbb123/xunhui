...
import wxbzxing.camera.CameraManager;
import com.google.zxing.client.result.ResultParser;
import wxbzxing.common.AmbientLightManager;
import wxbzxing.common.BeepManager;
import wxbzxing.common.BitmapUtils;
import wxbzxing.common.InactivityTimer;
import wxbzxing.common.IntentSource;
import wxbzxing.decode.BitmapDecoder;
import wxbzxing.decode.CaptureActivityHandler;
import wxbzxing.decode.FinishListener;
import wxbzxing.view.ViewfinderView;
...
//                Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.capture_scan_photo) { // 图片识别
            ...
            Intent data = new Intent();
            data.putExtra(SCAN_QRCODE_RESULT, "您已取消");
            setResult(0, data);
            finish();
        }
